...
class _HomePageState extends State<HomePage> {
  ...
  List<String> categories = ['Pasta', 'Vegetarian', 'Dessert', 'Chicken'];
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      // Agrega lógica para mostrar recetas de la categoría seleccionada
                    },
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16.0),
            Text(
              'Puntuación: ${recipe.score.toStringAsFixed(2)}',
              style: TextStyle(fontSize: 18.0),
            ),
            SizedBox(height: 16.0),
            ElevatedButton(
